...
{
	int x;
	if(t==0)return-1; //testa lista vazia
	for(x=0;x<t;x++)
		if(codigo[x]==cod) return x; //retorna O deslocamento do endereco base return-2; //percorreu toda a lista e nÃo achou
}	
